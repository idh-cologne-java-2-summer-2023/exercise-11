...
public class ATM {
	...
	/**
	 * Converts an amount to an array with the number of bills of each value. This
	 * function returns as few bills as possible, i.e., highest value first. (this
	 * is not popular in reality ...).
	 * 
	 * @param amount
	 * @return
